const eng = {
    ...
    threatmodel: {
        ...
        importThreats: {
            ...
            pasteJson: 'Paste JSON threat data',
            validate: 'Validate',
            import: 'Import',
            validationErrors: 'Validation Errors',
            validationPassed: 'JSON validation passed',
            validateFirst: 'Please validate the JSON first',
            invalidJson: 'Invalid JSON',
            matched: 'Successfully Matched Threats',
            unmatched: 'Unmatched Threats (will be skipped)',
            errors: 'Import Errors',
            formatInfo: 'JSON Format: Each threats should STRIDE details'
        },
        importProcesses: {
            title: 'Import Processes',
            pasteJson: 'Paste JSON process data',
            validate: 'Validate',
            import: 'Import',
            validationErrors: 'Validation Errors',
            validationPassed: 'JSON validation passed',
            validateFirst: 'Please validate the JSON first',
            invalidJson: 'Invalid JSON',
            matched: 'Successfully Imported Processes',
            errors: 'Import Errors',
            formatInfo: 'JSON Format: Each process should have "name", "endpoint", "parameter", and "description" fields'
        },
        exportThreats: {
            ...
            copyTooltip: 'Copy all process data to clipboard',
            download: 'Download',
            downloadTooltip: 'Download process data as JSON file',
